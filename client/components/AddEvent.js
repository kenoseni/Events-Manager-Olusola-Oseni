...
class AddEvent extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (
      nextProps.eventCenters.allCenters !== this.props.eventCenters.allCenters
    ) {
          ...
          <div className="modal fade right" id="addEvent" role="dialog">
            <div className="modal-dialog modal-full-height modal-right">
              ...
              <div className="modal-content">
                <div id="addEventModal" className="modal-header">
                  <h4
                    id="addEventTitle"
                  ...
                  <form action="" method="" role="form" onSubmit={this.submit}>
                    <div className="">
                      ...
                      <div className="container-fluid">
                        <div className="row">
                          <div id="addEventForm" className="col-12">
                    ...
                    <br />
                    <SubmitButton id="submitButton" name="ADD EVENT" />
                  </form>
                </div>
              </div>
            </div>
