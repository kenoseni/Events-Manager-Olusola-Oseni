...
describe('<SignUp />', () => {
  ...
  it('should click the login button and run a function', () => {
    ...
    wrapper.find('#c-button').simulate('click', { preventDefault() {} });
  ...
  it('should call onChange function', () => {
    ...
    wrapper.find('#fname').simulate('change', {
      target: { name: 'firstname', value: 'olusola' }
    });
    wrapper.find('#lname').simulate('change', {
      target: { name: 'lastname', value: 'oseni' }
    });
    wrapper.find('#mail').simulate('change', {
      target: { name: 'email', value: 'olu@gmail.com' }
    });
    wrapper.find('#pword').simulate('change', {
